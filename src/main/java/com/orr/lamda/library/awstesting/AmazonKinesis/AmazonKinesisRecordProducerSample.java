package com.orr.lamda.library.awstesting.AmazonKinesis;/*
...
public class AmazonKinesisRecordProducerSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            putRecordRequest.setData(ByteBuffer.wrap(String.format("Testing for Manjunath and ORR project-%d", createTime).getBytes()));
